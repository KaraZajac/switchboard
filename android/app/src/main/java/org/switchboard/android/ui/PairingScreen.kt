...
fun PairingScreen(
    ...
    Column(
        ...
        Text(
            "Pairing a desktop is how the two come to share one set of servers and settings, and how either of them can be the one that is actually connected. This phone works on its own either way.",
            color = Subtext,
            fontSize = 14.sp,
            lineHeight = 21.sp
        )
